    (function () {
      ...
      */
      ...
      console.log(text.replace(/(Manuel Marques de Sousa)/g, 'Carla Porto Veiga'));
      ...
      */
      ...
      console.log(text.replace(/(O Centauro de Luvas)/g, function(capturaTotal, frase) {
      ...
      */
      ...
      console.log(text.replace(/(de) (junho) (de)/, function(capturaTotal, grupo1, mes, grupo3) {
      ...
      */
      ...
      // var regexDate = text.replace(/(13 de)|(getMonthNumber(junho))|(de 1804)/, 
