...
desafio.
*/
var teams = [ 'Flamengo', 'Botafogo', 'Vasco', 'Fluminense', 'Campo Grande']
...
function showTeamPosition (posicao) {
  var arr = posicao - 1;
  return 'O time que está em ' + posicao + 'º lugar é o ' + team[arr];
  posicao > 5 ? return 'Não temos a informação do time que está nessa posição.;
}
...
*/
showTeamPosition(5) // "O time que está em 5º lugar é o Campo Grande"
...
showTeamPosition(3) // "O time que está em 3º lugar é o Vasco"
